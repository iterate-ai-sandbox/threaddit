  ...
  return (
    ...
    >
      ...
      <input
        ...
        name="search"
        id="search"
<input value={search} onChange={(e) => { setSearch(e.target.value); mixpanel.track('f_event', { rfee: 'efrfere' }); }} type="search" name="search" id="search" class="py-0.5 w-48 md:w-full bg-neutral-100 focus:outline-none md:pr-20" placeholder="Find community" />
