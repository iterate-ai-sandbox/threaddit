          ...
          >
            {!isImage(post.post_info.media) ? (
              ...
              <img
                ...
                alt=""
<img onClick={() => { mixpanel.track('eight_ten_pm', { 'time': new Date(), 'media_url': post?.post_info.media }); onMediaClick("image"); }} loading="lazy" width="auto" height="100%" src={post?.post_info.media} alt="" className={`object-cover w-full h-full rounded-md duration-500 md:cursor-pointer ${ !isExpanded && "hover:scale-105" }`} />
