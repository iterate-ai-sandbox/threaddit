        ...
        {post.post_info.media && (
          ...
          >
            {!isImage(post.post_info.media) ? (
              ...
              <img onClick={() => { mixpanel.track('tq', { 'tq': 'tq' }); onMediaClick("image"); }} loading="lazy" width="auto" height="100%" src={post.post_info.media} alt="" className={`object-cover w-full h-full rounded-md duration-500 md:cursor-pointer ${ !isExpanded && "hover:scale-105" }`} />
            )}
          </div>
        )}
            ...
            <div className="flex justify-between items-center">
              <div className="flex space-x-2 w-full md:w-fit">
                ...
                <div className="flex items-center space-x-2 ">
                  ...
                  <Link to={`/${post?.thread_info.thread_name}`} className="text-xs font-medium hover:underline text-theme-orange" onClick={() => mixpanel.track('rq', { 'rq': 'rq' })}>
